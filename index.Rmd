...
at showing the differences between the artists, and test how good classifiers can
be at differentiating between artists that all have the synthwave genre
in common.
...
indeed very similar. This is visible by the diagonal line in the plot. In some spots
...
contrasts the most compared to the other artists. It also performs great on all other artists.
It seems to struggle the most with Home, but that is relatively speaking.
...
tracks of different artists. The Random Forrest classifier proofs the observations made throughout 
the weeks, many of the significant features are indeed those that were previously identified.

The secondary objective is harder to quantify. The performance of the classifier is also incredible,
...
comparisons. Therefore the experimentation and final classification worked great and should be satisfactory. A possible point of
contention is the secondary objective. While the results clearly show great classification of artists, the same cannot truly be
said about subgenre classification. Choosing one artist to represent each artist was fine as an experiment, but it obviously
does not fully capture all variation within said subgenres. 
